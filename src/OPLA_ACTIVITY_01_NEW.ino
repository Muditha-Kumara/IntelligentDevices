...
void melody1() {
  if (touchCheckCompleted || shakeCheckCompleted || colorCheckCompleted || gestureCheckCompleted || relay1CheckCompleted || relay2CheckCompleted) {
...
void actuatorsPage()
{
  ...
  carrier.display.fillScreen(0x0000);
  carrier.display.setTextSize(2);
  carrier.display.drawBitmap(60, 30, carrier_logo, 120, 121, 0xFFFF); // display the MKR IoT Carrier image
  carrier.display.setCursor(25, 160);
  carrier.display.println("setup successful");
  carrier.display.setCursor(70, 190);
  carrier.display.println("CONGRATS!");
